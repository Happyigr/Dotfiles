...
export PATH=/home/popich/Apps/surrealdb:$PATH
...
#  ├─┤│ │ │ │ │  └─┐ │ ├─┤├┬┘ │ 
#  ┴ ┴└─┘ ┴ └─┘  └─┘ ┴ ┴ ┴┴└─ ┴ 
# chafa $HOME/Documents/Neofetch/PopCat.jpg --scale=1.8
# neofetch --config $HOME/.config/bspwm/neofetch/config.conf
